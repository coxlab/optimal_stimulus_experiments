...
norm.size = 7; norm.centering = 0; norm.gain = 1.0; norm.threshold = 1.0;
...
norm.size = 5; norm.centering = 0; norm.gain = 1.0; norm.threshold = 10.0;
...
filt.size = 7; filt.number = 128;
actv.min = 0; actv.max = 1; 
pool.size = 5; pool.order = 10; pool.stride = 2;
norm.size = 3; norm.centering = 1; norm.gain = 0.1; norm.threshold = 1.0;
...
norm.size = 7; norm.centering = 0; norm.gain = 0.1; norm.threshold = 0.1;
