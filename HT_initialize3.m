...
norm.size = 5; norm.centering = 0; norm.gain = 10.0; norm.threshold = 0.1;
...
filt.size = 7; filt.number = 64;
actv.min = 0; actv.max = Inf; 
pool.size = 5; pool.order = 2; pool.stride = 2;
norm.size = 5; norm.centering = 0; norm.gain = 1.0; norm.threshold = 1.0;
...
actv.min = -Inf; actv.max = 1; 
pool.size = 9; pool.order = 10; pool.stride = 2;
norm.size = 9; norm.centering = 1; norm.gain = 10.0; norm.threshold = 1.0;
